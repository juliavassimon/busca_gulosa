...
vetor.insere(grafo.portoUniao)
vetor.insere(grafo.saoJose)
vetor.insere(grafo.curitiba)
vetor.insere(grafo.tresBarras)
vetor.imprime()
...
class Gulosa:
  ...
  def buscar(self, atual):
    ...
    if atual == self.objetivo:
      ...
      if vetor_ordenado.valores[0] is not None and not vetor_ordenado.valores[0].visitado:
